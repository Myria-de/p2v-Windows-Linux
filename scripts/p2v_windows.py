...
def main():
    ...
    parser.add_argument("--imagefile", "-i", type=str, default="", help = "Nur Windows-Bootmanager einrichten")
    ...
    if IMAGEFILE != "":
        if NBDEFIPART == "" or NBDWINPART == "":
            print(f"{bcolors.RED}Sie müssen die Partitionsnummern in der Image-Datei angeben.{bcolors.NC}")
